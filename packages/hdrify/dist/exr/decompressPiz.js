 ...
 */
export function decompressPiz(compressedData, width, channels, _dataSize, blockHeight = 32) {
    ...
    if (compressedSize <= 0 || compressedSize > compressedData.length - offset) {
        throw new Error(`Invalid PIZ compressed size: ${compressedSize}, available: ${compressedData.length - offset}, offset: ${offset}, total length: ${compressedData.length}`);
    }
...
//# sourceMappingURL=decompressPiz.js.map