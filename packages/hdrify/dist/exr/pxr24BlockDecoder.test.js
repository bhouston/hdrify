 ...
 */
function buildSegmentLineMajorCxxOrder(width, deltas) {
...
describe('PXR24 block decoder (isolated, known-good inputs)', () => {
    ...
    it('decodes 2x2 RGB line-major payload (hand-built, C++ byte order)', () => {
        ...
        const setHalf = (offset, value) => {
            expected[offset] = value & 0xff;
            expected[offset + 1] = (value >> 8) & 0xff;
        };
        const offsetAt = (ly, c, x) => (ly * numChannels * width + c * width + x) * 2;
...
//# sourceMappingURL=pxr24BlockDecoder.test.js.map