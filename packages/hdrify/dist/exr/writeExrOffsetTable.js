 ...
 */
import { INT32_SIZE, NO_COMPRESSION, PIZ_COMPRESSION, PXR24_COMPRESSION, RLE_COMPRESSION, ULONG_SIZE, ZIP_COMPRESSION, ZIPS_COMPRESSION, } from './exrConstants.js';
 ...
 */
function getBlockSize(width, lineCount, bytesPerPixel) {
 ...
 */
export function buildExrOffsetTable(options) {
    const { width, height, compression, offsetTableStart, bytesPerPixel = 16, // RGBA float
     } = options;
 ...
 */
export function buildExrOffsetTableFromBlocks(options) {
...
//# sourceMappingURL=writeExrOffsetTable.js.map