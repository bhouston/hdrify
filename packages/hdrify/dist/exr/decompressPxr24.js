...
function getPxr24BytesPerSample(pixelType) {
    switch (pixelType) {
        case UINT:
            return 4;
        case HALF:
...
function getOutputBytesPerSample(pixelType) {
    switch (pixelType) {
        case UINT:
            return 4;
        case HALF:
 ...
 */
export function decompressPxr24(compressedData, width, channels, _dataSize, blockHeight) {
        ...
        for (let c = 0; c < numChannels; c++) {
            ...
            for (let x = 0; x < width; x++) {
                ...
                if (channel.pixelType === HALF) {
                    ...
                    const u32 = (untransposed[byteOff] << 24) |
...
//# sourceMappingURL=decompressPxr24.js.map