...
import { HALF, PIZ_COMPRESSION, PXR24_COMPRESSION, RLE_COMPRESSION, ZIP_COMPRESSION, ZIPS_COMPRESSION, } from './exrConstants.js';
...
import { buildExrOffsetTable, buildExrOffsetTableFromBlocks, getBlockCount, getBlockHeight, } from './writeExrOffsetTable.js';
import { writeExrScanBlock } from './writeExrScanBlock.js';
function getChannelsForCompression(compression) {
 ...
 */
export function writeExr(hdrifyImage, options) {
...
//# sourceMappingURL=writeExr.js.map