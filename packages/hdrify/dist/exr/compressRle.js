 ...
 */
export function compressRLE(rawData) {
    const out = [];
    let i = 0;
 ...
 */
export function compressRleBlock(rawHalfFloatInterleaved) {
...
//# sourceMappingURL=compressRle.js.map