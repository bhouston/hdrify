 ...
 */
export function float32ToF24(float) {
 ...
 */
export function f24ToFloat32(b0, b1, b2) {
 ...
 */
export function transposePxr24Bytes(src, bytesPerSample) {
 ...
 */
export function undoPxr24Transposition(src, bytesPerSample) {
    const totalSamples = src.length / bytesPerSample;
    const out = new Uint8Array(src.length);
    // biome-ignore-start lint/style/noNonNullAssertion: indices derived from src.length
    for (let s = 0; s < totalSamples; s++) {
...
//# sourceMappingURL=pxr24Utils.js.map