 ...
 */
import { applyMatrix3, LINEAR_REC709_TO_LINEAR_REC2020, LINEAR_REC2020_TO_LINEAR_REC709, mat3ToArray, } from '../color/matrixConversion.js';
 ...
 */
function acesFilmicBatch(input, output, pixelCount) {
    // biome-ignore-start lint/style/noNonNullAssertion: indices bounds-checked by pixelCount loop
    const m00 = 0.59719, m01 = 0.35458, m02 = 0.04823;
    const m10 = 0.076, m11 = 0.90834, m12 = 0.01566;
    const m20 = 0.0284, m21 = 0.13383, m22 = 0.83777;
    const o00 = 1.60475, o01 = -0.53108, o02 = -0.07367;
    const o10 = -0.10208, o11 = 1.10813, o12 = -0.00605;
    const o20 = -0.00327, o21 = -0.07276, o22 = 1.07602;
 ...
 */
function reinhardBatch(input, output, pixelCount) {
    // biome-ignore-start lint/style/noNonNullAssertion: indices bounds-checked by pixelCount loop
    for (let i = 0; i < pixelCount; i++) {
        const si = i * 3;
        const r = input[si];
 ...
 */
function neutralBatch(input, output, pixelCount) {
    // biome-ignore-start lint/style/noNonNullAssertion: indices bounds-checked by pixelCount loop
...
function agxDefaultContrastApprox(x) {
    const x2 = x * x;
    const x4 = x2 * x2;
 ...
 */
const agxVecIn = [0, 0, 0];
const agxVecOut = [0, 0, 0];
function agxBatch(input, output, pixelCount) {
    // biome-ignore-start lint/style/noNonNullAssertion: indices bounds-checked by pixelCount loop
    for (let i = 0; i < pixelCount; i++) {
        const si = i * 3;
        agxVecIn[0] = input[si];
...
export function getToneMapping(type) {
