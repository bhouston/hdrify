...
export const CANVAS_DISPLAY_COLOR_SPACES = ['srgb', 'display-p3'];
/** Map our DisplayColorSpace to Canvas PredefinedColorSpace where supported */
const DISPLAY_TO_CANVAS = {
    'display-srgb': 'srgb',
 ...
 */
export function getCanvasColorSpaceForDisplay(display) {
    return DISPLAY_TO_CANVAS[display];
}
//# sourceMappingURL=canvasColorSpace.js.map