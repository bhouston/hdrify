 ...
 */
function linearToRec2020Display(x) {
 ...
 */
function rec2020DisplayToLinear(x) {
    if (x <= 0.04045) {
 ...
 */
export function linearToDisplay(r, g, b, space) {
 ...
 */
export function displayToLinear(r, g, b, space) {
    // biome-ignore lint/nursery/noUnnecessaryConditions: exhaustive switch for DisplayColorSpace
    switch (space) {
        case 'display-srgb':
        case 'display-p3':
