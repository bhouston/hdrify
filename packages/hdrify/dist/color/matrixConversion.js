 ...
 */
export function chromaticitiesToRgbXyzMatrix(ch) {
 ...
 */
export function chromaticitiesToXyzRgbMatrix(ch) {
 ...
 */
export function buildLinearToLinearMatrix(from, to) {
 ...
 */
export function applyMatrix3(matrix, input, output, inputOffset = 0, outputOffset = 0) {
 ...
 */
export function applyMatrix3ToFloat32Array(data, matrix) {
...
export const LINEAR_REC709_TO_LINEAR_P3 = buildLinearToLinearMatrix(ch709, chP3);
/** Linear Rec.709 → Linear Rec.2020 */
export const LINEAR_REC709_TO_LINEAR_REC2020 = buildLinearToLinearMatrix(ch709, ch2020);
/** Linear P3 → Linear Rec.709 */
export const LINEAR_P3_TO_LINEAR_REC709 = buildLinearToLinearMatrix(chP3, ch709);
/** Linear P3 → Linear Rec.2020 */
export const LINEAR_P3_TO_LINEAR_REC2020 = buildLinearToLinearMatrix(chP3, ch2020);
/** Linear Rec.2020 → Linear Rec.709 */
export const LINEAR_REC2020_TO_LINEAR_REC709 = buildLinearToLinearMatrix(ch2020, ch709);
/** Linear Rec.2020 → Linear P3 */
export const LINEAR_REC2020_TO_LINEAR_P3 = buildLinearToLinearMatrix(ch2020, chP3);
const LINEAR_MATRIX_MAP = {
 ...
 */
export function getLinearToLinearMatrix(from, to) {
    if (from === to)
        return null;
    const key = `${from}-${to}`;
    return LINEAR_MATRIX_MAP[key];
}
//# sourceMappingURL=matrixConversion.js.map