 ...
 */
export function convertFloat32ToLinearColorSpace(data, _width, _height, from, to) {
 ...
 */
export function convertLinearColorSpace(image, to) {
 ...
 */
export function convertLinearToDisplay(image, to) {
    const targetLinear = DISPLAY_TO_LINEAR[to];
    const linearData = convertFloat32ToLinearColorSpace(image.data, image.width, image.height, image.linearColorSpace, targetLinear);
 ...
 */
export function convertDisplayToLinear(data, width, height, from, linearColorSpace) {
