 ...
 */
export function quantizeFloatToU8(x) {
 ...
 */
export function dequantizeU8ToFloat(b) {
 ...
 */
export function quantizeRgbaFloatToU8(floatRgba) {
 ...
 */
export function dequantizeU8ToRgbaFloat(u8) {
