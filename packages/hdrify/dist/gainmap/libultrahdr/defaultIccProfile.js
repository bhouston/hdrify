...
export function getDefaultIccProfile() {
    if (!cached)
        cached = buildSrgbIccPayload();
    return cached;
}
/** Same as getDefaultIccProfile(); kept for backward compatibility. */
export const DEFAULT_ICC_PROFILE = getDefaultIccProfile();
//# sourceMappingURL=defaultIccProfile.js.map