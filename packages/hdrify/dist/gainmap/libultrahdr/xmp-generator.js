 ...
 */
export function generateXmpForPrimaryImage(secondaryImageLength, metadata) {
    const lines = [];
 ...
 */
export function generateXmpForSecondaryImage(metadata) {
    const lines = [];
...
//# sourceMappingURL=xmp-generator.js.map