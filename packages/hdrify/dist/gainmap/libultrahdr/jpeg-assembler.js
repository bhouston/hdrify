...
function writeMarker(buffer, startPos, marker, data) {
...
export function assembleJpegWithGainMap(options) {
    ...
    const secondaryImageSize = 2 + // SOI
...
//# sourceMappingURL=jpeg-assembler.js.map