 ...
 */
export function extractImagesFromMpf(buffer) {
    ...
    let gainmapImage = null;
    const format = 'ultrahdr';
 ...
 */
export function extractImagesBySecondSoi(buffer) {
...
//# sourceMappingURL=mpfExtractor.js.map