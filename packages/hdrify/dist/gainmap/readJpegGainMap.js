 ...
 */
export function readJpegGainMap(buffer) {
    ...
    if (sdrDecoded.width !== gainDecoded.width || sdrDecoded.height !== gainDecoded.height) {
        gainData = new Uint8ClampedArray(scaleToSize(gainDecoded.data, gainDecoded.width, gainDecoded.height, width, height));
    }
...
function scaleToSize(src, sw, sh, dw, dh) {
...
//# sourceMappingURL=readJpegGainMap.js.map