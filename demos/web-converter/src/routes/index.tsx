...
const EXAMPLE_FILES: { value: string; label: string }[] = [
  ...
  { value: '/examples/cie-wedge-r.hdr', label: 'CIE Wedge R (HDR)' },
  { value: '/examples/cie-wedge-g.hdr', label: 'CIE Wedge G (HDR)' },
  { value: '/examples/cie-wedge-b.hdr', label: 'CIE Wedge B (HDR)' },
